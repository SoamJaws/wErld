...
%% Gothenburg
-define(COASTAL_STATS, [ #monthly_stats{maxTemp=1,  minTemp=-4, sunHours=1, rainDays=15, snowDays=13}
                       , #monthly_stats{maxTemp=1,  minTemp=-4, sunHours=2, rainDays=11, snowDays=9}
                       ...
                       , #monthly_stats{maxTemp=3,  minTemp=-2, sunHours=1, rainDays=15, snowDays=4}
                       ]).

%% Karlstad
-define(INLAND_STATS, [ #monthly_stats{maxTemp=-2, minTemp=-8, sunHours=1, rainDays=17, snowDays=26}
                      , #monthly_stats{maxTemp=-1, minTemp=-9, sunHours=2, rainDays=13, snowDays=28}
...
%% Luleå
-define(NORTHERN_STATS, [ #monthly_stats{maxTemp=-8, minTemp=-16, sunHours=0,  rainDays=16, snowDays=31}
                        , #monthly_stats{maxTemp=-8, minTemp=-16, sunHours=1,  rainDays=14, snowDays=28}
                        , #monthly_stats{maxTemp=-2, minTemp=-11, sunHours=3,  rainDays=13, snowDays=31}
                        ...
                        , #monthly_stats{maxTemp=-5, minTemp=-13, sunHours=0,  rainDays=16, snowDays=28}
                        ]).

%% Malmö
-define(SOUTHERN_STATS, [ #monthly_stats{maxTemp=2,  minTemp=-2, sunHours=1, rainDays=17, snowDays=1}
                        , #monthly_stats{maxTemp=2,  minTemp=-3, sunHours=2, rainDays=13, snowDays=1}
                        ...
                        , #monthly_stats{maxTemp=3,  minTemp=-1, sunHours=1, rainDays=17, snowDays=0}
                        ]).
