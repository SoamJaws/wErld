...
%% Gothenburg
-define(COASTAL_STATS, [ #monthly_stats{maxTemp=1,  minTemp=-4, sunHours=1, rainDays=15}
...
%% Karlstad
-define(INLAND_STATS, [ #monthly_stats{maxTemp=-2, minTemp=-8, sunHours=1, rainDays=17}
...
%% Luleå
-define(NORTHERN_STATS, [ #monthly_stats{maxTemp=-8, minTemp=-16, sunHours=0,  rainDays=16}
...
%% Malmö
-define(SOUTHERN_STATS, [ #monthly_stats{maxTemp=2,  minTemp=-2, sunHours=1, rainDays=17}
